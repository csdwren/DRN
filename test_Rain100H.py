...
parser = argparse.ArgumentParser(description="DRN_test_Rain100H")
parser.add_argument("--logdir", type=str, default="logs/Rain100H", help='path of log files')
parser.add_argument("--data_path",type=str, default="./test/Rain100H", help='path to test data')
parser.add_argument("--save_path", type=str, default="results_Rain100H", help='path to save results')
