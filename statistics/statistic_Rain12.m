...
gt_path = '../test/test12/groundtruth/';

DRN_Rain12_77_path='../test/test12/results_Rain12_inter7_intra7';

struct_model = {
struct('model_name','DRN_Rain12_77_path','path',DRN_Rain12_77_path),...
};
