...
sizeL=101;
gt_path='../test/Rain100L/';

DRN_Rain100L_77_path='../test/Rain100L/results_Rain100L_inter7_intra7';            
  
struct_model = {
struct('model_name','DRN_Rain100L_77_path','path',DRN_Rain100L_77_path),...  
};
